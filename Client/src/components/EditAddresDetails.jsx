...
const EditAddresDetails = ({ close, data }) => {
        ...
        <section className='bg-black/70 fixed top-0 left-0 right-0 bottom-0 z-50 h-screen overflow-auto'>
            <div className='bg-white p-4 w-full max-w-lg mt-8 mx-auto rounded'>
                ...
                <form className='mt-4 grid gap-4' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <button type='submit' className='bg-primary-200 w-full py-2 font-semibold hover:bg-primary-100 cursor-pointer mt-4'>Update</button>
                </form>
            </div>
        </section>
    )
...
export default EditAddresDetails