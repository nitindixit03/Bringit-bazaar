...
const EditProductAdmin = ({ close, data : propsData,fetchProductData }) => {
    ...
    return (
        <section className='fixed top-0 right-0 left-0 bottom-0  bg-neutral-900/90 z-50'>
            <div className='bg-white w-full max-w-2xl mx-auto rounded overflow-y-auto h-full max-h-[95vh]'>
