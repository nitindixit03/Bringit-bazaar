...
const UploadSubCategoryModel = ({ close, fetchData }) => {
  ...
  return (
    <section className='fixed top-0 right-0 bottom-0 left-0 bg-neutral-800/80 z-50 flex items-center justify-center p-4'>
      <div className='w-full max-w-5xl bg-white p-4 rounded'>
        ...
        <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
          ...
          <button className={`px-4 py-2 boder font-semibold
             ${subCategoryData.name && subCategoryData.image && subCategoryData.category[0] ? "bg-primary-200 hover:bg-primary-100" : "bg-gray-50"}
            `}
          > Submit</button>
