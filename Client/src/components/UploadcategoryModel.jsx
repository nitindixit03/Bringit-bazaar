...
const UploadcategoryModel = ({ close, fetchData }) => {
    ...
    return (
        <section className='fixed top-0 bottom-0 left-0 right-0 bg-neutral-800/80 p-4 flex items-center justify-center'>
                ...
                <form className='my-3 grid gap-2' onSubmit={handleSubmit}>
                    <div className='grid gap-1'>
                        ...
                        <input
                            ...
                            className='bg-blue-50 p-2 border border-blue-50 focus-within:border-primary-200 outline-none rounded'
                        />
                    </div>
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='flex gap-4 flex-col lg:flex-row items-center'>
                            ...
                            <label htmlFor='uploadCategoryImage'>
                                <div className={`
                                ${!data.name ? 'bg-gray-300 cursor-not-allowed' : 'border-primary-200  hover:bg-primary-100'}
