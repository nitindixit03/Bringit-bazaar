...
const ProductDisplayPages = () => {
  ...
  return (
    <section className='container mx-auto max-w-[90rem] p-4 grid lg:grid-cols-2 '>
      <div className=''>
        ...
        <div className='flex items-center justify-center gap-3 my-2'>
          {
            data.image.map((img, index) => {
              return (
                <div key={img + index + "point"} className={`bg-slate-200 w-3 h-3 lg:w-5 lg:h-5 rounded-full ${index === image && "bg-slate-500"}`}>
      ...
      <div className='p-4 lg:pl-7 text-base lg:text-lg'>
...

        {
          data.stock === 0 ? (
            ...
            // <button className='my-4 px-4 py-1 bg-green-600 hover:bg-green-700 text-white cursor-pointer'>Add</button>
            <div className='my-4'>
        ...
        <h2 className='font-semibold'>Why shop from bringit?</h2>
        <div>
