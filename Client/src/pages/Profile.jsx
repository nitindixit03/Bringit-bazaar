...
const Profile = () => {
  ...
  const handleSubmit = async (e)=>{
    ...
    const { data : responseData } = response   // responseData = response.data;
  ...
  return (
    <div className='p-4'>
      ...
      <div className='w-20 h-20 flex items-center justify-center rounded-full bg-amber-400 overflow-hidden drop-shadow-sm'>
        {
          user.avatar ? (
            <img
              alt={user.name}
